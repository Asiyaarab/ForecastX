...
![ForecastX Dashboard](assets/dashboard_preview.png)
<!-- TO ADD SCREENSHOT: take a screenshot of your running Streamlit app, save it as assets/dashboard_preview.png, commit it. -->
...
- Gradient Boosting model (Scikit-learn) with hyperparameter tuning
...
<!--
REPLACE THESE WITH YOUR ACTUAL NUMBERS - re-run your eval script and paste the real metrics.
...
|-- .gitignore              # ignore caches, venv, logs
|-- LICENSE
|-- README.md
```
